...
- 对于本格推理。禁止使用俗套的手法来编写剧本，比如常见的冰刀杀人、滑轮机关等作案手法。你应该创作一些反套路故事，诱导玩家的刻板印象，以增加游戏的乐趣和挑战。
- 对于设计的线索`clues`，需要审核“从玩家角度思考，该线索被确认之后是否为推理提供了帮助？”，谜面是公开信息，默认玩家是在通读谜题后才发出的提问。线索不应该是谜面中已经出现过的明显的内容，除非该内容有更深层的含义，你需要在线索中进行解释说明。
